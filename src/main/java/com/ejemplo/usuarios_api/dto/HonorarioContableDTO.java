...
public class HonorarioContableDTO {
    ...
    public HonorarioContableDTO(
            ...
            BigDecimal montoPagado, String estado, int anio,
            LocalDate fechaInicio, Long clienteId, List<MesHonorarioDTO> meses) {
    ...
    // Getters y Setters
    public Long getHonorarioId() { return honorarioId; }
    public void setHonorarioId(Long honorarioId) { this.honorarioId = honorarioId; }
    ...
    public List<MesHonorarioDTO> getMeses() { return meses; }
    public void setMeses(List<MesHonorarioDTO> meses) { this.meses = meses; }
}
